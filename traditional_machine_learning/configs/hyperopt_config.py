...
hyperopt_model_dict = {
    ...
    "elastic_net": {
        "type": "elastic_net",
        "feature_list": hp.choice(
            "feature_list_elastic_net", ["elastic_net_importance", "elastic_net_rfe"]
        ),
    ...
    "lasso": {
        "type": "lasso",
        "feature_list": hp.choice(
            "feature_list_lasso", ["lasso_importance", "lasso_rfe"]
        ),
    ...
    "ridge": {
        "type": "ridge",
        "feature_list": hp.choice(
            "feature_list_ridge", ["ridge_importance", "ridge_rfe"]
        ),
    ...
    "decision_trees": {
        "type": "decision_trees",
        "feature_list": hp.choice(
            "feature_list_dt", ["decision_trees_importance", "decision_trees_rfe"]
        ),
